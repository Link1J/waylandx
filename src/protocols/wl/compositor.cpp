...
void ::protocol::wl::compositor::bind(struct wl_client* client, void* data, uint32_t version, uint32_t id) noexcept
{}
...
void ::protocol::wl::surface::bind(struct wl_client* client, void* data, uint32_t version, uint32_t id) noexcept
{}
